...
<head>
  ...
  <link rel="stylesheet" href="../snippets/template-boilerplate-style.css?v=1">

  <!-- For the less-enabled mobile browsers like Opera Mini -->
  <link rel="stylesheet" media="handheld" href="../snippets/template-boilerplate-handheld.css?v=1">
