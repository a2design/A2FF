...
<h2 accesskey="5" id="mod_nav">Módulos navegacionais</h2>
<table summary="#">
    <tbody>
		<!--tr>
		...
		<tr>
			<th scope="row"><strong class="partial "title="">Modal</strong></th>
		...
		<tr>
			<th scope="row"><strong class="partial">Dropdown</strong></th>
			<td><a class="disable" 	href="snippets/arquivo.html">Demo</a></td>			
...
<a class="back" href="#logo">Voltar ao topo</a>
<h2 accesskey="3" id="mod_multi">Módulos multimídia (áudio, vídeo, texto, arquivo e imagem)</h2>
<table summary="#">
    <tbody>
		<tr>
...
<a class="back" href="#logo">Voltar ao topo</a>
<h2 accesskey="4" id="mod_form">Módulos para formulários</h2>
<table summary="#">
    <tbody>
		<tr>
